...
const api = {
    ...
    getCampaigns() {
        return fetch(`${this.hostname}/marketing/campaigns`).then((response) => response.json());
    },
    searchProducts(keyword, paging) {
        return fetch(`${this.hostname}/products/search?keyword=${keyword}&paging=${paging}`).then((response) => response.json());
    },
    getProduct(id) {
        return fetch(`${this.hostname}/products/details?id=${id}`).then((response) => response.json());
    },
