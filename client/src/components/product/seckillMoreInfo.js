...
import seckillProudctMoreInfo from "../../images/seckill-images.jpg"
const productMoreInfos = [seckillProudctMoreInfo];

const SeckillMoreInfo = () => {
    return (
...
export default SeckillMoreInfo;
